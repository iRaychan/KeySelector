...
## v3.2.3l
- Corrected Page 3 dimension table spacing to match the approved After reference.
- Moved the approximate dimension and weight note directly below the table.
